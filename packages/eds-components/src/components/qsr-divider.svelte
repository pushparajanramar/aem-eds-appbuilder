<svelte:options customElement="qsr-divider" />
...
<div class="divider divider--{orientation} divider--{spacing}" role="separator" aria-orientation={orientation}>
  {#if label}<span class="divider__label">{label}</span>{/if}
</div>
