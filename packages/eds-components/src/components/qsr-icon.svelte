<svelte:options customElement="qsr-icon" />
...
<span class="icon icon--{name}" style="width:{size}px;height:{size}px;{color ? `color:${color}` : ''}"
  aria-label={label || name} role={label ? 'img' : 'presentation'}>
