...
<style>
  ...
  .hero__content {
    ...
    background: linear-gradient(90deg, rgba(30, 57, 50, 0.75) 0%, transparent 60%);
    max-width: var(--max-width-content);
    margin: 0 auto;
  }

  .hero__content :global(h1),
  .hero__content :global(h2) {
    color: var(--color-white);
