<svelte:options customElement="qsr-image" />
...
<script>
  ...
  $: imgWidth = getImageWidthForDevice(devicetype);
</script>

<figure class="image">
  <picture>
    <source type="image/webp" srcset={buildDynamicMediaSrcset(src, imgWidth)} />
    <img class="image__img" src={buildDynamicMediaUrl(src, imgWidth, { format: 'jpeg' })}
      alt={alt} width={width || imgWidth} height={height} loading={loading} />
  </picture>
</figure>
