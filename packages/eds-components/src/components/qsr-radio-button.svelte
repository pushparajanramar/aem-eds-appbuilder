<svelte:options customElement="qsr-radio-button" />
...
<script>
  ...
  function handleChange(e) { dispatchEvent(new CustomEvent('qsr:radio-button:change', { detail: { name, value: e.target.value, checked: e.target.checked }, bubbles: true, composed: true })); }
</script>

<label class="radio-button">
  <input class="radio-button__input" type="radio" name={name} value={value}
