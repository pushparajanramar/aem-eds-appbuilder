<svelte:options customElement="qsr-checkbox" />
...
<script>
  ...
  function handleChange(e) { dispatchEvent(new CustomEvent('qsr:checkbox:change', { detail: { name, value: e.target.value, checked: e.target.checked }, bubbles: true, composed: true })); }
</script>
