 ...
 * User Profile Block
 *
 * Lazy-loads the sbux-user-profile Web Component via IntersectionObserver.
...
export default async function decorate(block) {
  ...
  const observer = new IntersectionObserver(
    async ([entry]) => {
      ...
      observer.disconnect();
      await import('/blocks/user-profile/sbux-user-profile.js');
      const wc = Object.assign(document.createElement('sbux-user-profile'), { market });
